...
if __name__ == "__main__":
    ...
    while True:
        ...
        if x == "q":
            cylinder.set_maximum_speed(10)
            time.sleep(0.3)
            cylinder.location(0)

        if x == "w":
            cylinder.set_maximum_speed(80)
            time.sleep(0.3)
...
############# show key map
        if x == "o":
            show_key_map()
            print("r-slow(within 2s both) t-12mm/s(rotgrp max fixed,cylinder calc) ")
...
###########################
        if x == "r":
           ...
           print("Capping/ De-Capping demo fixed para")
        #    gripper.init()
        #    cylinder.init()
        #    rotating_gripper.init()
        ...
        #    #rotating_gripper.relative_rotation_angle(10000)
           ...
           s = 0.5
           print( "Start De-Capping /Put bottle...")
           rotating_gripper.set_rotational_speed(int(17))
           time.sleep(3)
           gripper.location(600)
           cylinder.set_maximum_speed(int(100))
           time.sleep(0.5)
           cylinder.location(5000)
           time.sleep(0.5)
           rotating_gripper.position(100)
           ...
           cylinder.set_maximum_speed(int(3))
        ...
        if x == "t":
           ...
           print("Capping/ De-Capping demo fixed para 12mm/s")
        #    gripper.init()
        #    cylinder.init()
        #    rotating_gripper.init()
        ...
        #   s = 0.5
           ...
           while True:
               if rotating_gripper.check_rotation_status_no_msg() == False:
                   print("rot ",int(round(time.time() * 1000)) - tcheck) # count end print
               if cylinder.check_operational_status_no_msg() == False:
                   print("cyli ",int(round(time.time() * 1000)) - tcheck)
               if cylinder.check_operational_status_no_msg() == True and rotating_gripper.check_rotation_status_no_msg() == True:
                   print("break while", int(round(time.time() * 1000)) - tcheck)
                   break
                   
                
           #for i in range(100):
            #    print(cylinder.current_Feedback())
           
        #    while True:
        #        #cylinder.check_operational_status()
        #        if cylinder.check_operational_status() == 0:
        #             cval = cylinder.current_Feedback()
        #             print(cval)
        #        if cylinder.check_operational_status() == 1:
        #            break
