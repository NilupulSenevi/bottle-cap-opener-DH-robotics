...
if __name__ == "__main__":
    ...
    while True:
        ...
        if x == "+":
            Gripper_location += 10
            if Gripper_location>5000 :
                Gripper_location = 5000
            print("come down loc ", Gripper_location)
            cylinder.location(Gripper_location)
            
        if x == "-":
            Gripper_location -= 10
            if Gripper_location<0 :
                Gripper_location = 0
            print("come up loc ", Gripper_location)
            cylinder.location(Gripper_location)
